...
<head>
	...
	<title>ABAMADE eCommerce Platform | Slides</title>
	<!--favicon-->
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
						<div class="breadcrumb-title pr-3">Slides</div>
						<div class="pl-3">
					...
					<!--end breadcrumb-->
							...
							<div class="card">
						<div class="card-header">Add Slides
							<p><span style="color: #cc0000;"><?php echo (isset($_SESSION['errMsg']) ? $_SESSION['errMsg']:""); unset($_SESSION['errMsg']); ?></span></p>
						</div>
						<div class="card-body">
								<form method="POST" action="./assets/php/forms.php?code=3" enctype="multipart/form-data">
										<div class="form-group">
											<input class="form-control" type="text" name="title" placeholder="Slide Title" required="">
										</div>

										<div class="form-group">
											<input class="form-control" type="text" name="descr" placeholder="Small description">
										</div>
										<div class="form-group">
