			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<!--end breadcrumb-->
							...
							<div class="card">
						<div class="card-header">Add Products
							<p><span style="color: #cc0000;"><?php echo (isset($_SESSION['errMsg']) ? $_SESSION['errMsg']:""); unset($_SESSION['errMsg']); ?></span></p>
						</div>
						<div class="card-body">
								<form method="POST" action="../assets/php/forms.php?code=5" enctype="multipart/form-data">
										...
										<div class="form-group">
											<textarea class="mytextarea form-control" name="snote" placeholder="Product Specification" required="">&nbsp;</textarea>
										</div>
										<div class="form-group">
										...
										<textarea class="mytextarea" name="descr" required="" placeholder="Description">&nbsp;</textarea>
