                                    ...
                                    <div class="woocommerce">
                                        <div class="customer-login-form">
                                            ...
                                            <div class="text-content">
            									<h2 class="align-top">Successful Order with No: <?=strtoupper($_SESSION['orderNO']);?></h2>
            									<p>
                                                    Thank you <?= $_SESSION['customer_name'];?>, your order has being placed successfully. <br />
                                                    Your ordered items will be shipped to @ <?= $_SESSION['shipDetail']->address.'  '.$_SESSION['shipDetail']->city.' '.$_SESSION['shipDetail']->state; ?>
            									</p>
